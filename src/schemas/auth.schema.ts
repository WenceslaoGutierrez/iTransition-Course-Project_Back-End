...
export const registerSchema = z.object({
  body: z.object({
    firstName: z.string({ required_error: 'validation.name_required' }).min(1, 'validation.name_min_length'),
    lastName: z.string({ required_error: 'validation.name_required' }).min(1, 'validation.name_min_length'),
